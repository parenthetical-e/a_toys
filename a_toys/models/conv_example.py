...
# import data_mnist
from a_toys.datasets import download_mnist
...
if __name__ == '__main__':
    ...
    input_shape = (1, 28, 28)
    layer_specs = [
        conv_layer((5, 5), 6), maxpool_layer((2, 2)), conv_layer(
            (5, 5), 16), maxpool_layer((2, 2)), tanh_layer(120),
        tanh_layer(84), softmax_layer(10)
    ]
    ...
    N_weights, pred_fun, loss_fun, frac_err = make_nn_funs(input_shape,
                                                           layer_specs, L2_reg)
